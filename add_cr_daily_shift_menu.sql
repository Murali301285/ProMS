...
DECLARE @MenuName NVARCHAR(100) = 'Crusher Daily Shift Report'
DECLARE @MenuRouterLink NVARCHAR(100) = '/dashboard/reports/cr-daily-shift'
DECLARE @MenuIcon NVARCHAR(50) = 'FileText' -- or specific icon
