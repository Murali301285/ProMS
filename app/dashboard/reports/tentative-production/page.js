...
import pageStyles from './TentativePage.module.css';

export default function TentativeProductionPage() {
    const [filter, setFilter] = useState({
        reportType: 'TentativeProduction',
        date: '',
        shiftId: ''
    });
    ...
    return (
        <div className="h-screen flex flex-col bg-slate-50">
            ...
            <div className="bg-white border-b border-slate-200 px-6 py-4 shadow-sm z-10 print:hidden">
                <div className="mb-4">
                    <h1 className="text-xl font-bold text-slate-800">Tentative Production Qty</h1>
                    <p className="text-slate-500 text-xs">Daily production report for Waste, Coal, and Rehandling.</p>
                </div>

                <ReportFilter
                    reportType={filter.reportType}
                    setReportType={() => { }}
                    reportOptions={[{ value: 'TentativeProduction', label: 'Tentative Production Qty' }]}
