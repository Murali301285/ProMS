...
DECLARE @MenuName NVARCHAR(100) = 'Crusher Stoppage Cumulative'
DECLARE @MenuRouterLink NVARCHAR(100) = '/dashboard/reports/cr-stoppage-cumulative'
DECLARE @MenuIcon NVARCHAR(50) = 'AlertOctagon'
